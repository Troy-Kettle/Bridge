...
public class UpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bridge_input = findViewById(R.id.bridge_input2);
        ...
        update_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                name = bridge_input.getText().toString().trim();
                condition = condition_input.getText().toString().trim();
                date = date_input.getText().toString().trim();
                myDB.updateData(id, name, condition, date);
            }
        });
    ...
    void getAndSetIntentData(){
        if(getIntent().hasExtra("id") && getIntent().hasExtra("title") &&
            ...
            condition = getIntent().getStringExtra("author");
            date = getIntent().getStringExtra("pages");

            //Setting Intent Data
            bridge_input.setText(name);
            condition_input.setText(condition);
            date_input.setText(date);
            Log.d("stev", name +" "+ condition +" "+ date);
        }else{
